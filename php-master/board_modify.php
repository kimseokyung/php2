                    ...
                    <table class='table table-striped table-hover table-sm'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>내용</td>
                                <td>
                                    <textarea class="form-control" id="contants" name="contants" rows="3" required>
                                        <?php echo $row['contants']; ?>
                                    </textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>작성자</td>
                                <td><input type="text" class="form-control" id="author" name="author" placeholder="" required value="<?php echo $row['author']; ?>"></td>
                            </tr>
                            <tr>
                                <td>등록일</td>
